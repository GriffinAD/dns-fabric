...
- **`SemicircleGauge`** — arc gauge; see [Gauge primitive](../docs/operator/gauge-primitive.md).
...
[ADR-0049](../docs/adr/ADR-0049-operator-dashboard-fault-isolation-host-controls-v1.md)
